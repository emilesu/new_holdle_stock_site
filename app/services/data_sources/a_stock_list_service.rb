module DataSources
  class AStockListService
    ...
    INDUSTRY_MAPPING = {
      ...
      "其他采掘" => { sector: "石油石化", industry: "油气开采" },
      "其他采掘Ⅱ" => { sector: "石油石化", industry: "油气开采" },
      ...
      "油气开采" => { sector: "石油石化", industry: "油气开采" },
      "油气开采Ⅱ" => { sector: "石油石化", industry: "油气开采" },
      ...
      "煤炭开采" => { sector: "煤炭", industry: "煤炭开采" },
      "煤炭开采Ⅱ" => { sector: "煤炭", industry: "煤炭开采" },
      ...
      "石油开采Ⅱ" => { sector: "石油石化", industry: "油气开采" },
      ...
      "采掘服务" => { sector: "石油石化", industry: "油服" },
      "采掘服务Ⅱ" => { sector: "石油石化", industry: "油服" },
