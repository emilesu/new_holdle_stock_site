Rails.application.routes.draw do
  ...
  namespace :admin do
    ...
    get "stock_crawlers/us_finance_em", to: "stock_crawlers#us_finance_em"
    get "stock_crawlers/us_finance_em_single", to: "stock_crawlers#us_finance_em_single"
    get "stock_crawlers/a_stock_list", to: "stock_crawlers#a_stock_list"
    get "stock_crawlers/a_finance", to: "stock_crawlers#a_finance"
    get "stock_crawlers/a_finance_em", to: "stock_crawlers#a_finance_em"
