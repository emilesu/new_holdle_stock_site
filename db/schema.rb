...
ActiveRecord::Schema[7.1].define(version: 2026_08_11_065619) do
  ...
  create_table "stocks", force: :cascade do |t|
    ...
    t.index ["market", "sector", "industry", "pyramid_total_score"], name: "index_stocks_on_market_sector_industry_pyramid_total_score"
    ...
    t.index ["pinyin_initials"], name: "idx_stocks_pinyin_initials"
